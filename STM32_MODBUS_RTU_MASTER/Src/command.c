...
tCmdLineEntry g_psCmdTable[] = {
		{ "checkrecord",Cmd_check_record," : Check Record" },
		{ "deleteline",Cmd_delete_line," : Delete one line" },

		{ "network",Cmd_set_network," : Set IP, NETMASK, GATEWAY" },
		{ "mqtt",Cmd_set_mqttInfo," : Set mqtt setting" },
		{ "port0",Cmd_set_port0," : Set port 0 parameter" },
		{ "port1",Cmd_set_port1," : Set port 1 parameter" },
		{ "apikey",Cmd_set_apikey," : Set apikey" },
		{ "timeout",Cmd_set_timeout," : Set timeout" },
		{ "provision", Cmd_send_provision," : Send provision"},
		{ "telemetry",Cmd_set_telemetry," : Send telemetry" },

		{ "gettime",Cmd_get_time," : Check time" },
		{ "setmqttport", Cmd_mqtt_port," : Set mqtt port" },
		...
		{ "loadtable", Cmd_allocate_device," : List all device in allocated memory" },
		{ "setmutex", Cmd_set_mutex," : Set mutex for Modbus Task" },
		{ "offmutex", Cmd_off_mutex," : Set mutex for Modbus Task" },
		{ "check",Cmd_delete_device," : Delete device" },
		{ "deletechannel",Cmd_delete_channel," : Delete channel" },
		{ "device", Cmd_set_device," : Set device parameters" },
		{ "setconfig", Cmd_set_config," : Set all config" },
		{ "touch",Cmd_new_file," : Create new file" },
		{ "rm",Cmd_delete_file," : Delete one file" },
		{ "nano",Cmd_read_file," : Open one file" },
		{ "ls",Cmd_list_file," : List file in sd card" },
		{ 0, 0, 0 } };
